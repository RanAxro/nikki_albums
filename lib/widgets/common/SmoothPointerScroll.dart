...
class SmoothPointerScroll extends StatefulWidget{
  ...
  final Widget Function(BuildContext, ScrollController, ScrollPhysics, IndependentScrollbarController) builder; // common 返回 ScrollController 传入到需要的 ScrollView 上
...
class _SmoothPointerScroll extends State<SmoothPointerScroll>{
  ...
  void animateTo(){
    if(widget._duration == Duration.zero){
      ...
      scrollController.animateTo(offset, duration: widget._duration, curve: widget._curve);
    }
  }
