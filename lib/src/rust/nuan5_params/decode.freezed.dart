...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeBuildParam&&const DeepCollectionEquality().equals(other.field0, field0));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( ClothDiyParams field0)?  netHomeBuild,TResult Function( List<DiyHistoryShareCodeParams> field0)?  buildData,required TResult orElse(),}) {final _that = this;
switch (_that) {
case HomeBuildParam_NetHomeBuild() when netHomeBuild != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( ClothDiyParams field0)  netHomeBuild,required TResult Function( List<DiyHistoryShareCodeParams> field0)  buildData,}) {final _that = this;
switch (_that) {
case HomeBuildParam_NetHomeBuild():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( ClothDiyParams field0)?  netHomeBuild,TResult? Function( List<DiyHistoryShareCodeParams> field0)?  buildData,}) {final _that = this;
switch (_that) {
case HomeBuildParam_NetHomeBuild() when netHomeBuild != null:
return netHomeBuild(_that.field0);case HomeBuildParam_BuildData() when buildData != null:
return buildData(_that.field0);case _:
...
class HomeBuildParam_BuildData extends HomeBuildParam {
  const HomeBuildParam_BuildData(final  List<DiyHistoryShareCodeParams> field0): _field0 = field0,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is HomeBuildParam_BuildData&&const DeepCollectionEquality().equals(other._field0, _field0));
}
