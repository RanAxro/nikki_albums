...
/// @nodoc
mixin _$RichCameraParamsMomoHidden {
...
/// @nodoc
class $RichCameraParamsMomoHiddenCopyWith<$Res>  {
$RichCameraParamsMomoHiddenCopyWith(RichCameraParamsMomoHidden _, $Res Function(RichCameraParamsMomoHidden) __);
}


/// Adds pattern-matching-related methods to [RichCameraParamsMomoHidden].
extension RichCameraParamsMomoHiddenPatterns on RichCameraParamsMomoHidden {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>({TResult Function( RichCameraParamsMomoHidden_Enable value)?  enable,TResult Function( RichCameraParamsMomoHidden_Disable value)?  disable,required TResult orElse(),}){
final _that = this;
switch (_that) {
case RichCameraParamsMomoHidden_Enable() when enable != null:
return enable(_that);case RichCameraParamsMomoHidden_Disable() when disable != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>({required TResult Function( RichCameraParamsMomoHidden_Enable value)  enable,required TResult Function( RichCameraParamsMomoHidden_Disable value)  disable,}){
final _that = this;
switch (_that) {
case RichCameraParamsMomoHidden_Enable():
return enable(_that);case RichCameraParamsMomoHidden_Disable():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>({TResult? Function( RichCameraParamsMomoHidden_Enable value)?  enable,TResult? Function( RichCameraParamsMomoHidden_Disable value)?  disable,}){
final _that = this;
switch (_that) {
case RichCameraParamsMomoHidden_Enable() when enable != null:
return enable(_that);case RichCameraParamsMomoHidden_Disable() when disable != null:
...
switch (_that) {
case RichCameraParamsMomoHidden_Enable() when enable != null:
return enable();case RichCameraParamsMomoHidden_Disable() when disable != null:
...
switch (_that) {
case RichCameraParamsMomoHidden_Enable():
return enable();case RichCameraParamsMomoHidden_Disable():
...
class RichCameraParamsMomoHidden_Enable extends RichCameraParamsMomoHidden {
  const RichCameraParamsMomoHidden_Enable(): super._();
...
class RichCameraParamsMomoHidden_Disable extends RichCameraParamsMomoHidden {
  const RichCameraParamsMomoHidden_Disable({required this.momoPose, required this.horizontal, required this.distance, required this.height, required this.rotateMomo, required this.autoGroundSnap, required this.floatingEffect, required this.poseWithNikki}): super._();
 ...
 final  double height;
 final  double rotateMomo;
 final  bool autoGroundSnap;
 final  bool floatingEffect;
 final  bool poseWithNikki;

/// Create a copy of RichCameraParamsMomoHidden
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$RichCameraParamsMomoHidden_DisableCopyWith<RichCameraParamsMomoHidden_Disable> get copyWith => _$RichCameraParamsMomoHidden_DisableCopyWithImpl<RichCameraParamsMomoHidden_Disable>(this, _$identity);
...
/// @nodoc
abstract mixin class $RichCameraParamsMomoHidden_DisableCopyWith<$Res> implements $RichCameraParamsMomoHiddenCopyWith<$Res> {
  factory $RichCameraParamsMomoHidden_DisableCopyWith(RichCameraParamsMomoHidden_Disable value, $Res Function(RichCameraParamsMomoHidden_Disable) _then) = _$RichCameraParamsMomoHidden_DisableCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$RichCameraParamsMomoHidden_DisableCopyWithImpl<$Res>
    implements $RichCameraParamsMomoHidden_DisableCopyWith<$Res> {
  _$RichCameraParamsMomoHidden_DisableCopyWithImpl(this._self, this._then);

  final RichCameraParamsMomoHidden_Disable _self;
  final $Res Function(RichCameraParamsMomoHidden_Disable) _then;
...
@pragma('vm:prefer-inline') $Res call({Object? momoPose = null,Object? horizontal = null,Object? distance = null,Object? height = null,Object? rotateMomo = null,Object? autoGroundSnap = null,Object? floatingEffect = null,Object? poseWithNikki = null,}) {
  return _then(RichCameraParamsMomoHidden_Disable(
...
as double,rotateMomo: null == rotateMomo ? _self.rotateMomo : rotateMomo // ignore: cast_nullable_to_non_nullable
as double,autoGroundSnap: null == autoGroundSnap ? _self.autoGroundSnap : autoGroundSnap // ignore: cast_nullable_to_non_nullable
as bool,floatingEffect: null == floatingEffect ? _self.floatingEffect : floatingEffect // ignore: cast_nullable_to_non_nullable
as bool,poseWithNikki: null == poseWithNikki ? _self.poseWithNikki : poseWithNikki // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
