...
extension type const GameMap(int data) {
  ...
  static const Map<int, (((num, num), (num, num)), ((num, num), (num, num)))>
  _referencePoint = {
    1: (((10919, 3578), (-13579, -54188)), ((2882, 1076), (-532885, -215756))),
    2: (((2471, 2506), (-226337, 590110)), ((2217, 836), (-231603, 555634))),
    3: (((2777, 2090), (-9343, 29357)), ((1144, 3021), (-41953, 48031))),
    4: (((2514, 3620), (-258712, 289927)), ((966, 667), (-305950, 199720))),
    5: (((3484, 4011), (-264691, 271984)), ((784, 333), (-346999, 159860))),
    6: (((1234, 1722), (38156, 55446)), ((3347, 2711), (122843, 95361))),
  };
  ...
  (int, int) coordToPixel((num, num) coordinates) {
    ...
    final x =
        p1.$1 + (p2.$1 - p1.$1) * (coordinates.$1 - c1.$1) / (c2.$1 - c1.$1);
    final y =
        p1.$2 + (p2.$2 - p1.$2) * (coordinates.$2 - c1.$2) / (c2.$2 - c1.$2);
...
extension type const GameWeather(int data) {
  ...
  static const GameWeather rainbow = GameWeather(4);
  static const GameWeather seaOfStars = GameWeather(7);
...
extension type const GameInteractivePhotoState(bool data) {
  static const GameInteractivePhotoState falseState = GameInteractivePhotoState(
    false,
  );
  static const GameInteractivePhotoState trueState = GameInteractivePhotoState(
    true,
  );
...
extension type const GamePuzzleGame(int data) {
  ...
  static const Map<int, String> _map = {-1: "game_puzzle_game_-1"};
...
extension type const GamePose(int data) {
  static const Map<int, String> _map = {0: "game_pose_none"};
...
extension type const GameMomoClothesType(int data) {
  ...
  static const Map<int, String> _map = {10: "game_momo_clothes_cloak"};
...
extension type const GameDIYColorGrid(int data) {
  ...
  GameDIYColorPalette get palette => data == -1
      ? GameDIYColorPalette.custom
      : GameDIYColorPalette(1 + data ~/ 8);

  GameDIYColorSwatch get swatch =>
      data == -1 ? GameDIYColorSwatch(0) : GameDIYColorSwatch(1 + data % 8);
...
extension type const GameDIYOverridePatternA(bool data) {
  ...
  static const GameDIYOverridePatternA falseState = GameDIYOverridePatternA(
    false,
  );
  static const GameDIYOverridePatternA trueState = GameDIYOverridePatternA(
    true,
  );
...
extension type const GameWeaponSlotType(String data) {
  static const GameWeaponSlotType bubbleMachine = GameWeaponSlotType(
    "BubbleMachine",
  );
...
extension type const GameWeaponCustomState(String data) {
  static const GameWeaponCustomState close = GameWeaponCustomState(
    "Weapon.State.Close",
  );
  static const GameWeaponCustomState open = GameWeaponCustomState(
    "Weapon.State.Open",
  );
