...
class _TreeNode {
  ...
  const _TreeNode({required this.field, required this.indexPath});
}
...
class FieldTreeController extends ChangeNotifier {
  ...
  FieldTreeController({required Field root, this.maxDepth = 10})
    : _root = root {
      ...
      child: Column(
        ...
        children: List.generate(children.length, (index) {
          ...
          return _FieldNode(
            ...
            node: _TreeNode(field: child, indexPath: childPath),
            level: level + 1,
...
class _NodeItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final valueText = field.value == null
        ? ""
        : controller.getTranslation(
            field.stringValue,
