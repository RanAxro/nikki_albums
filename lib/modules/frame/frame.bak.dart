...
// import "package:nikkialbums/routes/setting/setting.dart";
// import "package:nikkialbums/routes/setting/versionInformation.dart";
// import "package:nikkialbums/common/common.dart";
// import "package:nikkialbums/app/ui.dart";
// import "package:nikkialbums/app/theme.dart";
...
//       future: game.findUid(),
//       common: (BuildContext context, List<Uid> uidList){
//         if(uidList.isEmpty){
...
//                     },
//                     common: (BuildContext context, avatar){
//                       /// TODO 替换uid
...
//       common: (BuildContext context, List<Game> customGame, Widget? child){
...
//                 showDialog(
//                   context: context,
//                   common: (context) => CustomAccountEditor(),
//                 );
//               },
...
//         common: (BuildContext context, Game? currentGame, Widget? child){
//           if(currentGame == null){
//             return Row(
//               spacing: listSpacing,
//               children: [
...
//               common: (BuildContext context, Widget? child){
//                 return Row(
//                   spacing: listSpacing,
//                   children: [
//                     RFutureBuilder(
//                       future: currentGame.selectedUid?.avatarImage,
//                       common: (BuildContext context, FileImage? image){
...
//                       common: (BuildContext context, Set<UidNote> notes, Widget? child){
...
//                       common: (BuildContext context, Set<GameShortcut> shortcuts, Widget? child){
...
//               common: (BuildContext context, String? info, Widget? child){
...
//           common: (BuildContext context, bool isHover, Widget? child){
...
//             common: (BuildContext context, ScrollController controller, ScrollPhysics physics, IndependentScrollbarController scrollbarController){
...
//         .where((ContentItem item) => item.supportedPlatforms.canRunPlatform)
//         .toList();
//   }
//
...
//                   selectedIndex: page,
//                   children: [
//                     for(final (int, ContentItem) item in items.indexed)
//                       AppRawButton(
...
//                           setState((){
//                             page = item.$1;
//                             controller.jumpToPage(item.$1);
//                             // controller.animateToPage(item.$1, duration: Duration(milliseconds: AppState.animationDuration.value), curve: Curves.easeIn);
//                           });
//                         },
//                         // isOpen: page == item.$1,
//                         child: Image(image: items[item.$1].icon, height: smallButtonSize - 10, color: AppTheme.of(context)!.colorScheme.primary.onColor,),
//                       ),
//                   ],
//                 ),
//               ),
