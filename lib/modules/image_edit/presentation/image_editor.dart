...
import "package:nikki_albums/modules/image_edit/domain/cropping.dart";
import "package:nikki_albums/modules/image_edit/domain/editor.dart";
import "package:nikki_albums/modules/image_edit/presentation/image_cropping.dart";

import "../domain/fragment.dart";
import "package:nikki_albums/widgets/app/component.dart";
import "package:nikki_albums/widgets/common/component.dart";
import "package:nikki_albums/utils/image/dominant_color.dart";
import "package:nikki_albums/utils/color/hsl.dart";
...
class _ImageEditorState extends State<ImageEditor> {
  ...
  Future<void> init() async {
    ...
    controller =
        widget.controller ??
        ImageEditorController(initPlate: ImageEditPlate.colorTuning);
  ...
  Future<bool> exportFile(BuildContext context) async {
    ...
    final ByteData? bytes = await processed.toByteData(
          ...
          Row(
            ...
            children: [
              ...
              AppButton.smallIcon(
                ...
                onClick: () {
                  controller.set(
                    controller.current.withFragment(
                      controller.current.fragment.copyWithMap({
            ...
            builder: (BuildContext context, Widget? child) {
              ...
              return AppSlider(
                ...
                onChanged: (double value) {
                  controller.set(
                    controller.current.withFragment(
                      controller.current.fragment.copyWithMap({type: value}),
                    ),
                  );
                },
              ...
              AppNavBuilder<int>(
                ...
                builder:
                    (
                      ...
                      int value,
                      void Function(int newValue) change,
                    ) {
                      return Row(
                        spacing: listSpacing,
                        children: [
                    ...
                    return AppButton.smallText(
                      ...
                      onClick: () {
                        controller.setFragment(
                          ImageFragmentParams.defaultParams,
                        );
                        controller.save();
                      },
                      child: AppIcon("refresh"),
