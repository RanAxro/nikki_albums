...
abstract class NikkiasManifest {
  ...
  static String encode(NikkiasManifest source) {
    final Map json = {nikkiasExtension: source.toMap()};
...
class AlbumBackupNikkiasManifest extends NikkiasManifest {
  static AlbumBackupNikkiasManifest? from(dynamic source) {
    ...
    return AlbumBackupNikkiasManifest(
  ...
  const AlbumBackupNikkiasManifest({required super.launcherChannel});
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is AlbumBackupNikkiasManifest &&
...
class ImageTransferNikkiasManifest extends NikkiasManifest {
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ImageTransferNikkiasManifest &&
          launcherChannel == other.launcherChannel &&
          uid == other.uid &&
...
class OtherNikkiasManifest extends NikkiasManifest {
  ...
  const OtherNikkiasManifest()
    : super(launcherChannel: LauncherChannel.unknown);
  ...
  @override
  Map<String, dynamic> toMap() {
    return {"manifestVersion": manifestVersion, "type": type.name};
  }
