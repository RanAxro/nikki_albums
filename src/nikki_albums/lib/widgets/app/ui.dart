...
class AppDivider extends StatelessWidget{
  ...
  @override
  Widget build(BuildContext context){
    return direction == Axis.horizontal ? VerticalDivider(
      width: thickness,
      thickness: thickness,
      indent: smallPadding,
      endIndent: smallPadding,
...
Future<T?> showProgressBar<T>({
  ...
  Widget Function(BuildContext context, void Function([T? value]) close)? completedBuilder,
}){
  return showDialog<T>(
    context: context,
            ...
            builder: (BuildContext context, double? progress, Widget? child){
              ...
              return Column(
                ...
                children: [
                  ...
                  ?buildChild,
                  if(progress != null && progress >= 1) ?completedBuilder?.call(context, ([T? value]) => Navigator.of(context).pop(value)),
                ],
              );
            },
          ),
...
class AppButtonStyle{
  ...
  final (ColorRole colorRole, ColorState colorState, bool isTransparent) Function(bool usable, bool isInside, bool isPressed)? shader;
...
class AppRawButton extends StatefulWidget{
  ...
  final Widget? child;
  final Widget? Function(BuildContext context, Widget? child, bool isHovered, bool isPressed)? builder;
...
class _AppRawButtonState extends State<AppRawButton>{
  ...
  Widget build(BuildContext context){
    ...
    final AppButtonStyle? style = widget.useConfiguration ? AppButtonConfiguration.of(context)?.style : null;

    final (colorRole, colorState, isTransparent) = widget.shader?.call(widget.usable, isInside, isPressed) ?? style?.shader?.call(widget.usable, isInside, isPressed) ?? (ColorRole.of(context), ColorState.normal, true);

    final Widget? child = widget.builder?.call(context, widget.child, isInside, isPressed) ?? widget.child;
    ...
    Widget button = AnimatedContainer(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.all(Radius.circular(widget.borderRadius ?? style?.borderRadius ?? 0)),
        color: isTransparent ? AppColorScheme.of(context).byRole(colorRole).byState(colorState).withAlpha(0) : AppColorScheme.of(context).byRole(colorRole).byState(colorState),
      ),
      width: widget.width ?? style?.width,
      height: widget.height ?? style?.height,
      constraints: widget.constraints,
      margin: widget.margin,
      child: child == null ? null : AppThemeRole(
        colorRole: colorRole,
        child: AppThemeState(
...
class AppButton extends StatelessWidget{
  ...
  (ColorRole colorRole, ColorState colorState, bool isTransparent) shader(BuildContext context, bool usable, bool isInside, bool isPressed){
    ColorRole colorRole = this.colorRole ?? ColorRole.of(context);
    ColorState colorState = ColorState.normal;
    bool isTransparent = usable ? this.isTransparent && !isInside && !isPressed : this.isTransparent;
  ...
  factory AppButton.smallText({
    ...
    Curve curve = Curves.linear,
    Alignment alignment = Alignment.center,
    EdgeInsetsGeometry? padding = const EdgeInsets.symmetric(horizontal: smallPadding),
    double? width,
    double? height = smallButtonSize,
    BoxConstraints? constraints,
    EdgeInsetsGeometry? margin,
...
class AppButtonStack extends StatefulWidget{
  ...
  const AppButtonStack({
    ...
    assert(direction == Axis.horizontal && buttonWidth != null || direction == Axis.vertical && buttonHeight != null,
...
class _AppButtonStackState extends State<AppButtonStack>{
  ...
  Widget build(BuildContext context){
    ...
    final double wholeSpacing =  widget.spacing + ((widget.direction == Axis.horizontal ? widget.buttonWidth : widget.buttonHeight) ?? 0);
    ...
    final Stack stack = Stack(
      children: [
        ...
        ValueListenableBuilder(
          ...
          builder: (BuildContext context, int? index, Widget? child){
            ...
            return AnimatedPositioned(
              ...
              width: widget.direction == Axis.horizontal ? widget.buttonWidth : null,
              height: widget.direction == Axis.vertical ? widget.buttonHeight : null,
              child: Center(
                child: AnimatedContainer(
                  duration: widget.duration,
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.all(Radius.circular(widget.borderRadius)),
                    color: transparent ? AppColorScheme.of(context).byRole(ColorRole.of(context)).hoveredColor.withAlpha(0) : AppColorScheme.of(context).byRole(ColorRole.of(context)).hoveredColor,
                  ),
                  width: widget.buttonWidth,
                  height: widget.buttonHeight,
                ),
        ...
        for(final double offset in dividerOffset)
          Positioned(
            left: widget.direction == Axis.horizontal ? offset - 0.5 * smallDividerThickness : 0,
            top: widget.direction == Axis.vertical ? offset - 0.5 * smallDividerThickness : 0,
            right: 0,
            bottom: 0,
            child: IgnorePointer(
              child: Align(
    ...
    return Center(
      child: SizedBox(
        ...
        height: widget.direction == Axis.horizontal ? widget.buttonHeight : null,
        child: stack,
      ),
    );
  }
...
class AppSwitch extends StatelessWidget{
  ...
  factory AppSwitch.smallIcon({
    ...
    Widget? child,
    Widget? Function(BuildContext context, Widget? child, bool isHovered, bool isPressed)? builder,
  }){
    return AppSwitch(
      duration: duration,
      curve: curve,
...
class _AppRadioStackState extends State<AppRadioStack>{
  ...
  Widget build(BuildContext context){
    ...
    final double wholeSpacing =  widget.spacing + (widget.direction == Axis.horizontal ? widget.buttonWidth : widget.buttonHeight);
      ...
      children: [
        ...
        ValueListenableBuilder(
          ...
          builder: (BuildContext context, int? index, Widget? child){
            ...
            return AnimatedPositioned(
              duration: lastIndex == null && widget.selectedIndex == null ? Duration.zero : widget.duration,
              left: widget.direction == Axis.horizontal ? offset : 0,
              top: widget.direction == Axis.vertical ? offset : 0,
              right: widget.direction == Axis.horizontal ? null : 0,
              bottom: widget.direction == Axis.vertical ? null : 0,
            ...
            return AnimatedPositioned(
              ...
              child: Align(
                ...
                child: AnimatedContainer(
                  ...
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.all(Radius.circular(widget.borderRadius)),
                    color: transparent ? AppColorScheme.of(context).byRole(ColorRole.of(context)).onHoveredColor.withAlpha(0) : AppColorScheme.of(context).byRole(ColorRole.of(context)).onHoveredColor,
                  ),
                  width: 2,
...
class AppNavBuilder<T> extends StatefulWidget{
  ...
  final Widget Function(BuildContext context, T value, void Function(T newValue) change) builder;
...
class AppIcon extends StatelessWidget{
  ...
  @override
  Widget build(BuildContext context){
    final Color color = AppColorScheme.of(context).byRole(ColorRole.of(context)).onByState(ColorState.of(context));
    ...
    return Image.asset(
      ...
      width: width,
      height: height,
      color: isDye ? opacity == null ? color : color.withAlpha((opacity! * 255).toInt()) : null,
    );
  }
}
  ...
  Widget build(BuildContext context){
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        hintStyle: TextStyle(color: AppColorScheme.of(context).byRole(ColorRole.of(context)).onColor),
  ...
  Widget build(BuildContext context){
    return Container(
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColorScheme.of(context).byRole(ColorRole.of(context)).onColor, width: tinyBorder),
      ),
      child: ClipRRect(
        borderRadius: const BorderRadius.all(Radius.circular(smallBorderRadius)),
        child: Row(
          children: [
            Container(
              padding: const EdgeInsets.symmetric(horizontal: smallPadding, vertical: tinyPadding),
              color: AppColorScheme.of(context).primary.hoveredColor,
              child: k == null ? null : AppText(k!, isTranslate: isTranslateKey),
            ),
            Container(
              padding: const EdgeInsets.symmetric(horizontal: smallPadding, vertical: tinyPadding),
              color: AppColorScheme.of(context).background.color,
              child: v == null ? null : AppText(v!, isTranslate: isTranslateValue),
            ),
          ],
        ),
      ),
    ...
    return Padding(
      ...
      child: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints){
          ...
          final double thumbLeft = activeTrackLength - 2 * ratio * sliderThickness;
            ...
            track = Stack(
              children: [
                ...
                Container(
                  ...
                  height: sliderThickness,
                  color: AppColorScheme.of(context).byRole(ColorRole.of(context)).onEnabledColor,
                ),
              ],
            );
          }else{
  ...
  Widget build(BuildContext context){
    return MenuAnchor(
      style: MenuStyle(
        ...
        backgroundColor: WidgetStateProperty.all(AppColorScheme.of(context).byRole(ColorRole.of(context)).color),
        alignment: widget.alignment,
      ),
      controller: controller,
      menuChildren: [
...
class _AppMapViewerState extends State<AppMapViewer> {
  ...
  void _setInitialTransform() {
    ...
    final double scale = widget.initScale ?? viewerSize.width * 0.8 / widget.imageSize.width;
      ...
      child: Stack(
        children: [
          ...
          AnimatedBuilder(
            ...
            child: IgnorePointer(
              child: Icon(Icons.location_on, color: Colors.red, size: widget.iconSize),
            ),
          ),
        ],
      ),
