...
class _ImageViewerState extends State<ImageViewer>{
  ...
  _toPreviousImage(){
    if(index > 0){
      index--;
      pageController.animateToPage(index, duration: widget.duration, curve: Curves.easeInOut);
    }
  }
  ...
  _horizontalFlip(){
    ...
    imageMatrix[page].value = (Matrix4.identity()..scale(-1.0, 1.0, 1.0)) * imageMatrix[page].value;
  }
  /// vertical flip
  _verticalFlip(){
    final int page = pageController.page?.round() ?? 0;
