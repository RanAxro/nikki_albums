              ...
              builder: (BuildContext context, Widget? child) {
                double length = controller._virtualScrollViewExtent == null
                    ...
                    : (0.8 *
                              viewport *
                              viewport /
                              controller._virtualScrollViewExtent!)
                          .clamp(thumbLength, viewport);
                        ...
                        onVerticalDragUpdate: (DragUpdateDetails details) {
                          switch (direction) {
                            case Axis.horizontal:
                              controller.progress +=
                                  details.delta.dx / (viewport - length);
                              break;
                            case Axis.vertical:
                              controller.progress +=
                                  details.delta.dy / (viewport - length);
                              break;
                          }
                        },
                        child: StatefulBuilder(
                          builder:
                              (
                                ...
                                void Function(void Function()) setThumbState,
                              ) {
                                return MouseRegion(
