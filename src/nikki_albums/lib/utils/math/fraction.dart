...
class Fraction{
  ...
  factory Fraction.fromNum(num number){
    ...
    // 这里使用基于精度的方法，限制分母大小
    final Fraction result = _decimalToFraction(decimalPart, maxDenominator: 10000);

    // 合并整数部分
    final int finalNumerator = wholePart * result.denominator + result.numerator;
  ...
  /// 将小数部分转换为分数（使用最佳有理逼近）
  static Fraction _decimalToFraction(double decimal, {required int maxDenominator}){
