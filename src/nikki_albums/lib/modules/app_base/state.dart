...
abstract class AppState{
  ...
  static final ValueNotifier<bool> isShowImageCustomData = _createStateValue<bool>(false);
  ...
  static Future<void> read() async{
    ...
    assign<bool>("isShowImageCustomData", (bool value) => isShowImageCustomData.value = value);
    assign<double?>("imageCustomDataWidgetSize", (double? value) => imageCustomDataWidgetSize.value = value);
    assign<String?>("creationDirectoryPath", (String? value) => creationDirectoryPath.value = value);
