      ...
      builder: (BuildContext context, ScrollController controller, ScrollPhysics physics, IndependentScrollbarController scrollbarController){
        return ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index){
            ...
            final String typeStr = deletionRecord.deletionAlbumType.map((AlbumType type) => context.tr(albumsInfoMap[type]!.name)).join(" | ");
                    ...
                    child: Column(
                      ...
                      children: [
                        Align(
                          ...
                          child: AppText(deletionRecord.deletionTime.toString().substring(0, 19), isTranslate: false, fontSize: 32),
                        ),
                        Row(
                          spacing: listSpacing,
                          children: [
                            AppKVText(k: "uid", isTranslateKey: false, v: deletionRecord.uid),
                            AppKVText(k: "quantity", v: deletionRecord.quantity.toString()),
