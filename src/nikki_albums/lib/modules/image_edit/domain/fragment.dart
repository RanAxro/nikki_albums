...
import "package:nikkialbums/utils/math/transform.dart";
...
class ImageFragmentParamDef{
  static const ImageFragmentParamDef temperature = ImageFragmentParamDef(ImageFragmentType.temperature, "image_edit.temperature", -1.0, 1.0, 0, colors: [Color(0xFF3B82F6), Color(0xFFF97316)]);
  static const ImageFragmentParamDef tint = ImageFragmentParamDef(ImageFragmentType.tint, "image_edit.tint", -1.0, 1.0, 0, colors: [Color(0xFF84CC16), Color(0xFFA855F7)]);
  static const ImageFragmentParamDef lightSense = ImageFragmentParamDef(ImageFragmentType.lightSense, "image_edit.lightSense", -1.0, 1.0, 0);
  static const ImageFragmentParamDef exposure = ImageFragmentParamDef(ImageFragmentType.exposure, "image_edit.exposure", -1.0, 1.0, 0);
  static const ImageFragmentParamDef brightness = ImageFragmentParamDef(ImageFragmentType.brightness, "image_edit.brightness", -1.0, 1.0, 0);
  static const ImageFragmentParamDef contrast = ImageFragmentParamDef(ImageFragmentType.contrast, "image_edit.contrast", -1.0, 1.0, 0);
  static const ImageFragmentParamDef highlights = ImageFragmentParamDef(ImageFragmentType.highlights, "image_edit.highlights", -1.0, 1.0, 0);
  static const ImageFragmentParamDef shadows = ImageFragmentParamDef(ImageFragmentType.shadows, "image_edit.shadows", -1.0, 1.0, 0);
  static const ImageFragmentParamDef whites = ImageFragmentParamDef(ImageFragmentType.whites, "image_edit.whites", -1.0, 1.0, 0);
  static const ImageFragmentParamDef blacks = ImageFragmentParamDef(ImageFragmentType.blacks, "image_edit.blacks", -1.0, 1.0, 0);
  static const ImageFragmentParamDef vibrance = ImageFragmentParamDef(ImageFragmentType.vibrance, "image_edit.vibrance", -1.0, 1.0, 0);
  static const ImageFragmentParamDef saturation = ImageFragmentParamDef(ImageFragmentType.saturation, "image_edit.saturation", -1.0, 1.0, 0);
  static const ImageFragmentParamDef hslHue = ImageFragmentParamDef(ImageFragmentType.hslHue, "image_edit.hsl_hue", -1.0, 1.0, 0, hue: true);
  static const ImageFragmentParamDef hslSaturation = ImageFragmentParamDef(ImageFragmentType.hslSaturation, "image_edit.hsl_saturation", -1.0, 1.0, 0);
  static const ImageFragmentParamDef hslLightness = ImageFragmentParamDef(ImageFragmentType.hslLightness, "image_edit.hsl_lightness", -1.0, 1.0, 0);
  static const ImageFragmentParamDef cyanRed = ImageFragmentParamDef(ImageFragmentType.cyanRed, "image_edit.cyan_red", -1.0, 1.0, 0, colors: [Color(0xFF06B6D4), Color(0xFFEF4444)]);
  static const ImageFragmentParamDef magentaGreen = ImageFragmentParamDef(ImageFragmentType.magentaGreen, "image_edit.magenta_green", -1.0, 1.0, 0, colors: [Color(0xFFD946EF), Color(0xFF22C55E)]);
  static const ImageFragmentParamDef yellowBlue = ImageFragmentParamDef(ImageFragmentType.yellowBlue, "image_edit.yellow_blue", -1.0, 1.0, 0, colors: [Color(0xFFEAB308), Color(0xFF3B82F6)]);
  static const ImageFragmentParamDef clarity = ImageFragmentParamDef(ImageFragmentType.clarity, "image_edit.clarity", -1.0, 1.0, 0);
  static const ImageFragmentParamDef fade = ImageFragmentParamDef(ImageFragmentType.fade, "image_edit.fade", 0.0, 1.0, 0);
...
class ImageFragmentProgram{
  ...
  static Future<ImageFragmentProgram> load() async{
    return ImageFragmentProgram._(_program ??= await ui.FragmentProgram.fromAsset(
  ...
  ui.FragmentShader shaderWith(ui.Image image, double offsetX, double offsetY, double width, double height, ImageFragmentParams params){
...
class ImageFragmentPainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size){
    ...
    canvas.drawRect(
      ...
      Paint()..shader = shader.shaderWith(image, offset.dx, offset.dy, drawSize.width, drawSize.height, params),
    );
  }
...
class ImageFragmentHandler{
  ...
  const ImageFragmentHandler({
    required this.image,
  });

  Future<ui.Image> handle(ImageFragmentParams params, {ImageFragmentProgram? shader}) async{
    ...
    final ImageFragmentProgram program = shader ?? await ImageFragmentProgram.load();
