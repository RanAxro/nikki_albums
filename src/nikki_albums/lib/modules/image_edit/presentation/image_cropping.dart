...
class _ImageCroppingState extends State<ImageCropping>{
  ...
  final ValueNotifier<CropFrameAnchorPoint> anchorPoint = ValueNotifier<CropFrameAnchorPoint>(CropFrameAnchorPoint.none);
  ...
  MouseCursor getCursor(CropFrameAnchorPoint anchorPoint){
    return switch(anchorPoint){
      ...
      CropFrameAnchorPoint.leftBottom => SystemMouseCursors.resizeUpRightDownLeft,
      CropFrameAnchorPoint.rightBottom => SystemMouseCursors.resizeUpLeftDownRight,
    };
  }
  ...
  Widget build(BuildContext context){
    return Row(
      children: [
        ...
        SizedBox(
          width: 200,
          child: ImageCroppingPanel(controller: controller),
        ),
      ],
    );
  }
      ...
      builder: (BuildContext context, BoxConstraints constraints){
        ...
        return Listener(
          ...
          onPointerHover: (PointerHoverEvent event){
            if(widget.isDrawFrame && widget.allowControl){
              anchorPoint.value = controller.getAnchorPoint(event.localPosition);
            }
          },
          child: ListenableBuilder(
            ...
            builder: (BuildContext context, Widget? child){
              return ValueListenableBuilder(
                ...
                builder: (BuildContext context, CropFrameAnchorPoint anchorPoint, Widget? child){
                  return MouseRegion(
                  ...
                  children: [
                    Positioned(
                      ...
                      child: RotatedBox(
                        ...
                        child: widget.child == null ? null : KeepAliveWrapper(
                          child: widget.child!,
                        ),
                      ),
                    ),
                    ...
                    if(widget.isDrawFrame)
                      Positioned.fill(
                        child: CustomPaint(
                          ...
                          size: Size(controller.imageWidth, controller.imageHeight),
                        ),
                      ),
                  ],
                ),
...
class ImageCroppingFramePainter extends CustomPainter{
  ...
  void paint(Canvas canvas, Size size){
    ...
    // 左下角
    canvas.drawCircle(frameRect.bottomLeft, decoration.cornerRadius, cornerPaint);
    // 右下角
    canvas.drawCircle(frameRect.bottomRight, decoration.cornerRadius, cornerPaint);
