...
import "package:nikkialbums/frame/frame.dart";
import "package:nikkialbums/ui/ui.dart";
...
class ImageViewerDialog extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    ...
    final Widget toolButtons = AppButtonStack(
      divider: game == null ? const [2, 4, 2] : const [2, 4, 2, 2],
      children: [
        AppRawButton(
        ...
        AppRawButton(
          ...
          child: AppIcon("horizontal_flip", height: 20),
        ),
        ...
        AppRawButton(
          ...
          child: AppIcon("vertical_flip", height: 20),
        ),
          ...
          builder: (BuildContext context, bool isShowImageCustomData, Widget? child){
            return Tooltip(
              ...
              child: AppUncontrolledSwitch(
                ...
                child: AppIcon("image_custom_data"),
              ),
            );
          },
        ),
