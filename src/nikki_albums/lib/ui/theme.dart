...
enum ColorRole{
  ...
  static ColorRole of(BuildContext context){
    return context.dependOnInheritedWidgetOfExactType<AppThemeRole>()?.colorRole ?? AppThemeRole.defaultRole;
  }
}
...
enum ColorState{
  ...
  static ColorState of(BuildContext context){
    return context.dependOnInheritedWidgetOfExactType<AppThemeState>()?.colorState ?? AppThemeState.defaultState;
  }
}
...
class AppColorScheme{
  ...
  static AppColorScheme of(BuildContext context){
    return context.dependOnInheritedWidgetOfExactType<AppTheme>()?.colorScheme ?? AppTheme.defaultTheme;
  }
}
