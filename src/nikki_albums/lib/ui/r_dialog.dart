...
class AppDialog extends StatelessWidget{
  ...
  Widget build(BuildContext context){
              ...
              children: [
                Expanded(
                  child: Padding(
                    ...
                    child: AppText(title!, isTranslate: isTranslate, fontSize: smallButtonContentSize),
                  ),
                ),
                if(useCloseButton)
                  AppButton.small(
    ...
    child = ConstrainedBox(
      constraints: constraints ?? BoxConstraints(maxWidth: maxWidth ?? double.infinity, maxHeight: maxHeight ?? double.infinity),
      child: Padding(
                      ...
                      SizedBox(
                        ...
                        child: Row(
                          children: [
                            ...
                            Expanded(
                              child: AppText(title, isTranslate: isTranslate, fontWeight: FontWeight.bold),
                            ),
                            AppButton.small(
                              onClick: hide,
                              child: AppIcon("cross"),
