...
class RTextFiled extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return TextField(
      ...
      style: TextStyle(color: AppTheme.of(context)!.colorScheme.byRole(colorRole).onColor),
      decoration: InputDecoration(
        ...
        hintStyle: TextStyle(color: AppTheme.of(context)!.colorScheme.byRole(colorRole).onColor),
        ...
        filled: true,
        fillColor: AppTheme.of(context)!.colorScheme.byRole(colorRole).enabledColor,
      ),
    );
  }
}